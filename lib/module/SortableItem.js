  ...
  return /*#__PURE__*/_jsx(SortableItemContext, {
    ...
    children: /*#__PURE__*/_jsx(Reanimated.View, {
      ...
      children: /*#__PURE__*/_jsx(DraxView, {
        ...
        onSnapEnd: snapData => {
          // Read at CALL time, not render time. _internal is rebuilt as a
          // fresh literal (onItemSnapEnd: undefined) on every useSortableList
          // render and only patched with finalizeDrag by SortableContainer's
          // useLayoutEffect AFTER the pass. Cells normally render in a later
          // pass than the hook (FlatList batching), so a render-time
          // destructure usually captures the patched value — but a data
          // change re-renders cells synchronously in the SAME pass, and a
          // drop landing before their next render then calls a captured
          // undefined: the snap completes and the reorder silently commits
          // nothing.
