 ...
 */
export function useWebScrollFreeze(scrollRef) {
  ...
  const getScrollNode = () => {
    ...
    return list.getScrollableNode?.() ?? list._listRef?.getScrollableNode?.() ?? null;
  };
  const freeze = () => {
...
//# sourceMappingURL=useWebScrollFreeze.js.map